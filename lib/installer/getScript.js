...
// Render script
const render = ({ createdAt, huskyHomepage, huskyVersion, pkgDirectory, pkgHomepage, pmName, pmVersion, relativeUserPkgDir }) => `#!/bin/sh
 ...
 */
function default_1({ relativeUserPkgDir, pmName, pmVersion }) {
